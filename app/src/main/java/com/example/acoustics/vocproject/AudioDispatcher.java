...
public class AudioDispatcher implements Runnable {
    ...
    public AudioDispatcher(final TarsosDSPAudioInputStream stream, final int audioBufferSize, final int bufferOverlap, int id){
        idOfAudioSession = id;
    ...
    public int getIdOfAudioSession() {
        return idOfAudioSession;
    }
